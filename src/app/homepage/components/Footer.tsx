...
import { IconFacebook, IconWhatsApp, IconInstagram, IconLinkedIn } from "../../components/icons";
    ...
    >
      <div className="max-w-[1400px] mx-auto flex flex-col items-center gap-10">
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500, fontSize: "20px", lineHeight: 1.5 }}
        >
        ...
        <motion.div variants={fadeInUpItem} className="flex items-center gap-6">
          ...
          <a href="#" className="hover:opacity-80 transition-opacity" aria-label="LinkedIn">
            <IconLinkedIn fill="#EDEDED" size={22} />
          </a>
        </motion.div>
        ...
        <motion.div variants={fadeInUpItem} className="flex flex-col md:flex-row items-center gap-6 md:gap-12 pt-6 border-t border-white/10 w-full justify-center">
          ...
          >
            <span
              ...
              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "18px" }}
            >
              (+351) 964 140 860
            </span>
